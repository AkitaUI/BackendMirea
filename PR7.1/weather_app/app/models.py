...
class UserPrefs(Base):
    ...
    theme: Mapped[str] = mapped_column(String(20), default="light")      # light/dark/colorblind
    lang: Mapped[str] = mapped_column(String(10), default="ru")          # ru/en
...
class Forecast(Base):
    ...
    __table_args__ = (UniqueConstraint("city", "date", "source_id", name="uq_city_date_source"),)

    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    city: Mapped[str] = mapped_column(String(100), nullable=False)
    date: Mapped[str] = mapped_column(String(20), nullable=False)  # YYYY-MM-DD (простая форма)
